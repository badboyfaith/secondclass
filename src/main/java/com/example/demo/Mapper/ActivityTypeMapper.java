...
public interface ActivityTypeMapper {
    ...
    @Select("SELECT * FROM activity_type WHERE at_module = #{atModule} AND at_name = #{atName}")
    ActivityType findByAtModuleAndAtName(@Param("atModule") String atModule, @Param("atName") String atName);
}