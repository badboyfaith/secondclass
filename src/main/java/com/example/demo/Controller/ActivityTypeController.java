...
public class ActivityTypeController {
    ...
    /**
     * 创建一条新活动类型记录，带有业务逻辑验证--API验证成功
     * {
     *     "atId": 3,
     *     "atModule": "Ideological and political literacy",
     *     "atName": "School level activities"
     * }
     */
    @PostMapping
    ...
    @PostMapping("/batch")
    public String createActivityTypes(@RequestBody List<ActivityType> activityTypes) {
